...
var Fixtures = function() {
  ...
  var logFile =
    ...
    '00.00.00.01 - - [12/Feb/2012:15:48:19 -0500] "GET /robots.txt HTTP/1.0" 404 529 "http://localhost/robots.txt" "SomeSpider+(compatible; MSIE 7.0; Windows NT 5.1; Trident/4.0)"\n' +
    '000.00.0.02 - - [12/Feb/2012:16:53:37 -0500] "GET /robots.txt HTTP/1.0" 404 169 "-" "Mozilla/5.0 (compatible; ABot/v1.4.2; http://www.boturl.com+)"\n' +
    '000.00.0.02 - - [12/Feb/2012:16:53:39 -0500] "GET / HTTP/1.0" 200 3740 "-" "Mozilla/5.0 (compatible; ABot/v1.4.2; http://www.boturl.com+)"\n' +
  ...
  expectedEntries = [
    ...
    { "host":"00.00.00.01", "date":"12/Feb/2012", "request":"/robots.txt", "status":"404", "bytes":"529", "referrer":"http://localhost/robots.txt", "userAgent":"SomeSpider+(compatible; MSIE 7.0; Windows NT 5.1; Trident/4.0)" },
    { "host":"000.00.0.02", "date":"12/Feb/2012", "request":"/robots.txt", "status":"404", "bytes":"169", "referrer":"-", "userAgent":"Mozilla/5.0 (compatible; ABot/v1.4.2; http://www.boturl.com+)" },
    { "host":"000.00.0.02", "date":"12/Feb/2012", "request":"/", "status":"200", "bytes":"3740", "referrer":"-", "userAgent":"Mozilla/5.0 (compatible; ABot/v1.4.2; http://www.boturl.com+)" },
